...
import ContentCardsInfo from "./components/contentCardsInfo/contentCardsInfo";
import "./App.css";
import SocialButton from "./components/socialButton/SocialButton";
import Service from './components/service/service';

const AppWebsite = () => {
  const clickDoneCookies = () => {
  ...
  return (
    <>
      ...
      <SocialButton />
      <FullCard />
      <div className="ContainerForCookieAgrement" id="cookieAgreement">
        <div className="CookieAgrement">
          <div className="cookieAlert">
            ...
            <div className="contentInformationForCookies">
              <p className="classContentInformationParagraph__Cookies">
                საიტი სარგებლობის გაგრძელებით, შენ ეთანხმები Cookie ჩანაწერების
                გამოყენებას იხილეთ მეტი ინფორმაციისთვის{" "}
                <span style={{ textDecoration: "underline" }}>Cookie</span>{" "}
                პოლიტიკა
              </p>
            </div>
            <div className="buttonForContentFlexEnd">
              <button
                className="approveToGetCookies__btn"
                onClick={clickDoneCookies}
              >
                ვეთანხმები
              </button>
            </div>
